...
class GraphFromORMxml(BaseTopology,
    ...
    QGIS module. The in_res and out_res attributes of the vertices are aggregated into a single array giving the
    probability for an agent to move from cell i to j.
    """
